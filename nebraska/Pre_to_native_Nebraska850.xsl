...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xmcStrings="xmc.xslt.extensions.StringExtension" xmlns:java="http://xml.apache.org/xslt/java">
				...
				<xsl:when test="$record-id='PER'">
					<administrative-communications-contact>
						...
						<communication-number-qualifier>
						    <xsl:value-of select="xmcStrings:delimited($line-content,3,$elementSeparator,$elementSeparator)"/></communication-number-qualifier>
				...
				<xsl:when test="$record-id='N1'">
					<header-entity-loop>
						<entity-identifier-code>
							<xsl:value-of select="xmcStrings:delimited($line-content,1,',',',')"/>
						</entity-identifier-code>
						<name>
							<xsl:value-of select="xmcStrings:delimited($line-content,2,',',',')"/>
						</name>
						<identification-code-qualifier>
							<xsl:value-of select="xmcStrings:delimited($line-content,3,',',',')"/>
						</identification-code-qualifier>
						<identification-code>
							<xsl:value-of select="xmcStrings:delimited($line-content,4,',',',')"/>
						</identification-code>
	...
	<xsl:template name="createSE">
		...
		<transaction-set-trailer>
			...
			<transaction-set-control-nbr>
				<xsl:value-of select="xmcStrings:delimited($se-line,2,$elementSeparator,$elementSeparator)"/>
			</transaction-set-control-nbr>
		</transaction-set-trailer>
	</xsl:template>
</xsl:stylesheet>
...
<metaInformation>
<scenarios ><scenario default="yes" name="Scenario1" userelativepaths="yes" url="prepro_nebraskafurnmart.xml" htmlbaseurl="" processortype="xalan" commandline="" additionalpath="" additionalclasspath="D:\XSLExtensionsLIB\xalan.jar;d:\XSLExtensionsLIB\xml&#x2D;apis.jar;d:\XSLExtensionsLIB\xml.jar;d:\XSLExtensionsLIB\xerces.jar;d:\XSLExtensionsLIB\xmcXSLExtensions.jar; d:\XSLExtensionsLIB\xsltc.jar" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/><scenario default="no" name="Scenario1" userelativepaths="yes" url="..\preprocessed&#x2D;po.xml" htmlbaseurl="..\" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperInfo  srcSchemaPath="..\" srcSchemaRoot="" srcSchemaPathIsRelative="yes" destSchemaPath="..\" destSchemaRoot="" destSchemaPathIsRelative="yes" />
</metaInformation>
-->
