		...
		<xsl:if test="$record-id!=''">
			...
			<xsl:when test="$record-id='DTM'">
				...
				<subline-item-detail>
					...
					<unit-price>					  
					    <xsl:value-of select="xmcStrings:delimited($line-content,10,$elementSeparator,$segSeparator)"/>                      
					</unit-price>					
				</subline-item-detail>
		   </xsl:when>
...
<metaInformation>
<scenarios ><scenario default="yes" name="Scenario1" userelativepaths="yes" url="jordans850pp.xml" htmlbaseurl="Bernhardt\" processortype="xalan" commandline="" additionalpath="" additionalclasspath="D:\XSLExtensionsLIB\xalan.jar;d:\XSLExtensionsLIB\xml&#x2D;apis.jar;d:\XSLExtensionsLIB\xml.jar;d:\XSLExtensionsLIB\xerces.jar;d:\XSLExtensionsLIB\xmcXSLExtensions.jar; d:\XSLExtensionsLIB\xsltc.jar" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/><scenario default="no" name="Scenario1" userelativepaths="yes" url="..\preprocessed&#x2D;po.xml" htmlbaseurl="..\" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperInfo  srcSchemaPath="..\" srcSchemaRoot="" srcSchemaPathIsRelative="yes" destSchemaPath="..\" destSchemaRoot="" destSchemaPathIsRelative="yes" />
</metaInformation>
-->
